...
void NonUniformBspline::clearControlPoint() {
...
Eigen::VectorXd NonUniformBspline::evaluateDeBoor(const double& u) {
  ...
  // std::cout<<"u_(p_) "<<u_(p_)<<std::endl;
  // std::cout<<"u_(m_ - p_) "<<u_(m_ - p_)<<std::endl;
  // std::cout<<u_.size()<<std::endl;
  // for(int i = 0;i<u_.size();i++){
  //   std::cout<<u_(i)<<std::endl;
  // }
  // std::cout<<interval_<<std::endl;
  // exit(0);
